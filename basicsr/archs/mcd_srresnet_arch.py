...
class DropMSRResNet(nn.Module):
    ...
    def __init__(self, num_in_ch=3, num_out_ch=3, num_feat=64, num_block=16, upscale=4, dropout_rate=0.1):
        super(DropMSRResNet, self).__init__()
